...
var lose, winning, explosionSound,rechargesound;
...
function preload(){
  ...
  explosionSound = loadSound("assets/shot.mp3")
  rechargesound=loadSound("assets/recharge.mp3")
...
player = createSprite(displayWidth-1150, displayHeight-300, 50, 50);
 player.addImage(shooterImg)
   ...
   heart1.visible = false
    ...
    // Creando grupos para zombis,balas y recarga
...
if(keyDown("LEFT_ARROW")||touches.length>0 && player.x<0){
...
function enemy(){
  if(frameCount%50===0){
    ...
    zombie = createSprite(random(1100,1500),random(100,500),40,40)
...
function boxrecharge(){
  if(frameCount%200===0){

    // Dando posiciones "x" e "y" aleatorias cuando aparecen los zombis
    box = createSprite(random(500,1100),random(100,500),30,30)
